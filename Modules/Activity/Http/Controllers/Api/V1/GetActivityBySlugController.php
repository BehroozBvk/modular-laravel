 ...
 */
final class GetActivityBySlugController extends BaseApiV1Controller
{
    /**
     ...
     *
     * This endpoint retrieves a specific activity by its slug.
     *
     * @urlParam slug string required The slug of the activity. Example: summer-coding-camp
     * 
    ...
    {
        try {
            $activity = $this->activityService->getActivityBySlug($slug);
