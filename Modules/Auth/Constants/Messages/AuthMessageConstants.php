...
final class AuthMessageConstants
{
    ...
    public const VALIDATION_EXISTS = 'auth::messages.validation.exists';
    ...
    public const ATTRIBUTE_ADDRESS = 'auth::messages.attributes.address';
    public const ATTRIBUTE_CITY = 'auth::messages.attributes.city';
    public const ATTRIBUTE_STATE = 'auth::messages.attributes.state';
    public const ATTRIBUTE_ZIP = 'auth::messages.attributes.zip';
